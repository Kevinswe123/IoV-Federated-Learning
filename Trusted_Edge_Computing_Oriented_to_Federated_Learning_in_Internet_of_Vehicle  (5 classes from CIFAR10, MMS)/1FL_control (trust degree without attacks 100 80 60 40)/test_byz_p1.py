...
def parse_args():
    ...
    parser.add_argument("--frac", help="fraction of minigroup clients", type=float, default=1.0)
...
def main(args):
    ...
    niter = args.niter
    frac = args.frac
#generate 100 random trust degrees
    trust_value_list100 = []
    for i in range(20):
        x = round(random.uniform(0.9,1.0),6)
        trust_value_list100.append(x)
    for i in range(30):
        x = round(random.uniform(0.8,0.9),6)
        trust_value_list100.append(x)
    for i in range(40):
        x = round(random.uniform(0.7,0.8),6)
        trust_value_list100.append(x)
    for i in range(10):
        x = round(random.uniform(0.65,0.7),6)
        trust_value_list100.append(x)
#
    print("trust_value_list100",trust_value_list100)
    ...
    with ctx:
        ...
        wandb.init(
            ...
            name="FL_app_controlGroup(MMS)_5classes_testTrustDegreeWithoutAttacks" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
...
#########
        ...
        for e in range(niter):
            ...
            for i in idxs_minigroup:
                ...
                score_list.append(trust_value_list100[i])

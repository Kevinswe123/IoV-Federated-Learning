...
#new list containing 9 clients
    ...
    with ctx:
        ...
        wandb.init(
            project="FL_application_4th(MMS)",
            name="FL_app_4th_2_malicious_per_round(trust value based)(MMS)_5classes" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
...
#plot pics
        ...
        for e in range(niter):
            ...
            train_locals_loss = []
            print("m:",m)
            idxs_minigroup = list(mal_part_idxes) + list(np.random.choice(trust_value_idxes, size=m-2, replace=False)) #eg.:5,7,4,1,2,6 (exclude 9)

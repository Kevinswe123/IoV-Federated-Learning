...
#new list containing 9 clients
    ...
    #find 2 min idx to perform attack
    ...
    with ctx:
        ...
        wandb.init(
            ...
            name="FL_app_3rd_1_malicious_per_round(trust value based)(MMS)_5classes" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
...
#plot pics
        ...
        for e in range(niter):
            ...
            train_locals_loss = []
            print("m:",m)
            idxs_minigroup = list(np.random.choice(mal_part_idxes, size=1, replace=False)) + list(np.random.choice(trust_value_idxes, size=m-1, replace=False)) #eg.:5(7),4,1,2,6,3 (exclude 9)

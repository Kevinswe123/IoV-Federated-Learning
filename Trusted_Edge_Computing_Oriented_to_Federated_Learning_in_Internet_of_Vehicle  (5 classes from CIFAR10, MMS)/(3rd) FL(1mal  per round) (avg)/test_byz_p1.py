...
#    trust_value_list = [1/6,1/6,1/6,1/6,1/6,1/6,1/6,1/6,1/6,1/6]
...
#new list containing 9 clients
    ...
    #set 1 idx (5 or 7) to perform attack
    two_min_values1,two_min_values2 = np.partition(trust_value_list,1)[0:2]
    print("two_min_values",two_min_values1,two_min_values2)

    idxes_malicious1 = trust_value_list.index(two_min_values1)
    idxes_malicious2 = trust_value_list.index(two_min_values2)
    mal_part_idxes = [idxes_malicious1,idxes_malicious2]
    trust_value_idxes = list(range(9))
    trust_value_idxes.pop(idxes_malicious2)
    trust_value_idxes.pop(idxes_malicious1)
    print("trust_value_list",trust_value_list)
    print("two_min_values_idx(mal_part_idxes)",mal_part_idxes)
    print("trust_value_idxes",trust_value_idxes)
    ...
    with ctx:
        ...
        wandb.init(
            project="FL_application_3rd(MMS)",
            name="FL_app_3rd_1_malicious_per_round(avg)(MMS)_5classes" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
...
#plot pics
        ...
        for e in range(niter):
            ...
            train_locals_loss = []
            print("m:",m)
            idxs_minigroup = list(np.random.choice(mal_part_idxes, size=1, replace=False)) + list(np.random.choice(trust_value_idxes, size=m-1, replace=False)) #eg.:5(7),4,1,2,6,3
            logging.info("chosen_client_indexes = " + str(idxs_minigroup))
            print("idxs_minigroup:",idxs_minigroup)
   #         print("trust_value_list[minigroup]:",trust_value_list[idxs_minigroup])
...
#                grad_list.append([param.grad().copy() for param in net.collect_params().values()])
                ...
                nd_aggregation1.fltrust(grad_list, net, lr, args.nbyz, byz, score_list,value_remove,two_min_values1,idxes_malicious1,two_min_values2,idxes_malicious2)

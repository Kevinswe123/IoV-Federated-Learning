...
def parse_args():
    ...
    parser.add_argument("--frac", help="fraction of minigroup clients", type=float, default=0.4)
...
def main(args):
    ...
    niter = args.niter
    frac = args.frac
#generate 40 random trust degrees
    trust_value_list40 = []
    for i in range(40):
        x = round(random.uniform(0.9,1.0),6)
        trust_value_list40.append(x)
    for i in range(60):
        x = round(random.uniform(0.85,0.9),6)
        trust_value_list40.append(x)
#
    print("trust_value_list40",trust_value_list40)
    ...
    with ctx:
        ...
        wandb.init(
            ...
            name="FL_app_controlGroup(MMS)_5classes_testTrustDegreeWithoutAttacks_100XUAN40" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
...
#########
        ...
        for e in range(niter):
            ...
            for i in idxs_minigroup:
                ...
                score_list.append(trust_value_list40[i])

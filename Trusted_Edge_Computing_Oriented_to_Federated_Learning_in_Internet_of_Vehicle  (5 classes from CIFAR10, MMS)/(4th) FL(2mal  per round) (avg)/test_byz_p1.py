...
#new list containing 9 clients
    ...
    #set 2 mal idx to perform attack
    ...
    with ctx:
        ...
        wandb.init(
            ...
            name="FL_app_4th_2_malicious_per_round(avg)(MMS)_5classes" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(

...
def parse_args():
    ...
    parser.add_argument("--frac", help="fraction of minigroup clients", type=float, default=0.8)
...
#generate 80 random trust degrees
    ...
    for i in range(25):
        ...
        trust_value_list80.append(x)
    for i in range(40):
        x = round(random.uniform(0.8,0.9),6)
        trust_value_list80.append(x)
    for i in range(35):
        x = round(random.uniform(0.75,0.8),6)
        trust_value_list80.append(x)
#
    print("trust_value_list80",trust_value_list80)
...
#########
        ...
        for e in range(niter):
            ...
            for i in idxs_minigroup:
                ...
                score_list.append(trust_value_list80[i])

...
#new list containing 9 clients
    ...
    print("two_min_values_idx",idxes_malicious1,idxes_malicious2)
    ...
    with ctx:
        ...
        wandb.init(
            project="FL_application_2nd(MMS)",
            name="FL_app_2nd_random_select_2malicious(MMS)avg_5classes" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
        ...
        for X_batch,y_batch in test_data:
            print("X_batch_train has shape {}, and y_batch_train has shape {}".format(X_batch.shape,y_batch.shape))
        print("train_data row",len(test_data))
#plot pics
        ...
        for e in range(niter):
            ...
            train_locals_loss = []
            print("m:",m)
            idxs_minigroup = np.random.choice(range(num_workers-1), size=m, replace=False) #eg.:4,1,2,5,6,8 (exclude 9)

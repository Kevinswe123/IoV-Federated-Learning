...
#new list containing 9 clients
    ...
    with ctx:
        ...
        wandb.init(
            project="FL_application_1st(MMS)",
            name="FL_app_1st(MMS)avg_5classes" + str(args.dataset) + "+" + "net " + str(args.net) + "+" +"niter " + str(args.niter) +"+nworkers " + str(
        ...
        for X_batch,y_batch in test_data:
            print("X_batch_test has shape {}, and y_batch_test has shape {}".format(X_batch.shape,y_batch.shape))
